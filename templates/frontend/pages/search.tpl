            ...
            <aside class="col-md-4 search">
                ...
                <form class="search__form" method="get" action="{$smarty.capture.searchFormUrl|strtok:"?"|escape}">
                    ...
                    <div class="form-group form-group-date-from">
                        ...
                        <div class="form-control-date row g-3">
            ...
            <section class="col-md-8">
                ...
                <div class="search_results">
                    {iterate from=results item=result}
                        {include file="frontend/objects/article_summary.tpl" article=$result.publishedSubmission journal=$result.journal showDatePublished=true hideGalleys=true showAbstractsOnIssuePage=$showAbstractsOnIssuePage}
                    {/iterate}
                </div>
