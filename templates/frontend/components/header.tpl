    ...
    <div class="container-fluid">
        ...
        {if $displayPageHeaderLogo}
            <a href="{$homeUrl}" class="is_img">
                <img src="{$publicFilesDir}/{$displayPageHeaderLogo.uploadName|escape:"url"}" width="{$displayPageHeaderLogo.width|escape}" height="{$displayPageHeaderLogo.height|escape}" {if $displayPageHeaderLogo.altText != ''}alt="{$displayPageHeaderLogo.altText|escape}"{else}{capture assign="defaultAltText"}{translate key="common.pageHeaderLogo.altText" defaultValue=$applicationName}{/capture}alt="{$defaultAltText|escape}"{/if} />
            </a>
