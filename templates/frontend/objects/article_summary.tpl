...
<article class="article">
	<div class="row">
		...
		{/if}
		<div class="col-md-{if $requestedOp === "search"}12{else}8{/if}{if !$coverImageUrl && $requestedOp !== "search"} offset-md-4{/if} {if $showAbstractsOnIssuePage === 'fadeoutAbstracts'}article__abstract-fadeout {if $section.section}article__abstract-fadeout-{$section.section->getId()}{/if}{/if}">
			{if $showAuthor}
